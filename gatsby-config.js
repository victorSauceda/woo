...
module.exports = {
  ...
  siteMetadata: {
    ...
    menuItems: [
      { path: "features", label: "Artists" },
      { path: "pricing", label: "About Us" },
      { path: "screenshots", label: "Portfolio" },
      { path: "testimonials", label: "Testimonials" },
      { path: "subscribe", label: "Schedule an appointment" },
    ],
    ...
    social: [
      {
        service: `Facebook`,
        url: `https://www.facebook.com/alec.witten`,
        fa: `facebook`,
      },
      {
        service: `Twitter`,
